...
// Define ApplicationInformation interface.
...
//TODO create exception by error code
...
exports.getCurrentApplication = function() {
  ...
  var appInfo = new ApplicationInformation(result.appInfo);
  return new Application(appInfo, result.appContext.contextId);
};
